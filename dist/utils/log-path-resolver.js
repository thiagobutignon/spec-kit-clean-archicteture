 ...
 */
export function resolveLogDirectory(contextPath, subDirectory) {
    // Validate input
    if (!contextPath) {
 ...
 */
export function resolveDebugDirectory(contextPath, subDirectory) {
    // Validate input
    if (!contextPath) {
 ...
 */
export function resolveRLHFDirectory(contextPath) {
    if (contextPath) {
        if (typeof contextPath !== 'string') {
            throw new Error(`Context path must be a string, received: ${typeof contextPath}`);
        }
