---
title: "Validate Layer JSON Plan"
...
parameters:
  input:
    type: "json"
    description: "JSON plan generated by /01-plan-layer-features command"
    required: true
  output_success:
    type: "json"
...
- **JSON Plan:** The JSON object generated by the `/01-plan-layer-features` command
