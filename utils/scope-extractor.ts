 ...
 */
export function extractScope(filePath: string): ArchitecturalScope {
  if (!filePath) {
    return 'core';
  }
  ...
  if (layerMatch) {
    ...
    return layer as ArchitecturalScope;
  }
 ...
 */
export function isValidScope(scope: string): scope is ArchitecturalScope {
